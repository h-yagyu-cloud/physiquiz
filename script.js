...
async function setupQuizPage() {
    ...
    try {
        ...
        sourceIndicator.style.marginTop = '10px';
        sourceIndicator.style.color = '#888';
        sourceIndicator.style.textAlign = 'right';
        sourceIndicator.textContent = `Data Source: ${loadedFrom}`;

        if (loadedFrom === 'local' && fetchError) {
